...
class FlaskClient(BaseClient):
    ...
    # 注册用户
    def register_user(self, username:str, password:str, email:str, access:int=1,other_info:dict=None,**kwargs):
        body = {
            "username": username,
            "password": password,
            "email": email,
    ...
    # 修改用户信息
    def update_user(self, username:str, password:str, email:str=None, access:int=1,other_info:dict=None,**kwargs):
        body = {
            "username": username,
            "password": password,
            "email": email,
    ...
    # 添加商品信息
    def add_product(self, name:str, price:float,type_:str,subtype:str, description:str=None, status:int=2,  other_info:dict=None,**kwargs):
        body = {
    "name":name,
    "price":price,
    ...
    # 修改商品信息
    def update_product(self, product_id:int, name:str, price:float,type_:str,subtype:str, description:str=None, status:int=2,  other_info:dict=None,**kwargs):
        body = {
    "name":name,
    "price":price,
    "description":description,
    ...
    def delete_product(self, product_id:int, **kwargs):
        return self.send_requests("POST","/api/product/delete", json={"product_id":product_id}, **kwargs)

    # 根据条件查询查询商品信息
    def search_product(self, name:str=None, type_:str=None, subtype:str=None, status:int=None, **kwargs):
        return self.send_requests("POST","/api/product/search", json={"name":name, "type":type_, "subtype":subtype, "status":status}, **kwargs)
